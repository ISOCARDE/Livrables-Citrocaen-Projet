...
/**
* @fn void CAN2Init(void)
* @brief intialisation du CAN de boost
*/
void CAN2Init(short filtre)
{
    ...
    CANAssignMemoryBuffer(CAN2,CAN2MessageFifoArea,1 * 1 * CAN_TX_RX_MESSAGE_SIZE_BYTES);
    ...
    CANConfigureFilter(CAN2, CAN_FILTER0, filtre, CAN_SID);
    CANConfigureFilterMask  (CAN2, CAN_FILTER_MASK0, CAN_MASQUE_BOOST, CAN_SID, CAN_FILTER_MASK_IDE_TYPE);
...
/**
* @fn void CAN2InitFiltre(short filtre)
* @brief changement de la valeur du filtre 0
*/
void CAN2InitFiltre(short filtre)
{
...
/**
* @fn void CAN2TxSendMsg(void)
* @brief envoie de message du boost
*/
void CAN2TxSendMsg(char typeReq)
{
