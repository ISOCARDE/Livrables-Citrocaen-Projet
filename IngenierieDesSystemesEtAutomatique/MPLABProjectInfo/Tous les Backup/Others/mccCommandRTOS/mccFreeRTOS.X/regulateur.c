...
float regulateur_final(float *commande,float *V_consigne,float *VO_mesuree){
    ...
    /*Te = 0.0004*/
    float num[4] ={0.00486466909923440,0.00284722069606930,0.00180964211311415,0.00365911088463550} ;
    float den[4] ={1,0.231157856429446,-0.987981644705010,-0.243176211724436};
