...
void TacheRegulation( void *pvParameters ){
    ...
    const portTickType xFrequency = 1;  //appel de la fonction toutes les 300us
...
//            transfert(VO_mesuree,commande,consigne);
            ...
            /*transfert seconde*/
//            transfert2(VO_mesuree,commande);
...
//            }
//            else if(ref>=20 && ref<26){
//                nouvelle_Commande  = regulateur(commande,V_consigne,
//                        VO_mesuree,Rn_24V,Rd_24V,Rp_24V);
//            }
//            else if(ref>=26 && ref<32){
//                nouvelle_Commande  = regulateur(commande,V_consigne,
...
//                        VO_mesuree,Rn_36V,Rd_36V,Rp_36V);
            ...
            /* Troisième Régulateur : PI*/
//            nouvelle_Commande = regulateur_PI(commande,V_consigne,VO_mesuree);

            /* Troisième régulateur  : calcul de la commande*/
//            nouvelle_Commande = regulateur_trois(commande,V_consigne,VO_mesuree);

            
            /*Changement du rapport cyclique du PWM*/
            if(algo == 1){
                pwmSet( (1-nouvelle_Commande) * T3_TICK); //a changer !
            }
            else{
