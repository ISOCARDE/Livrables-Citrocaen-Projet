...
C = tf(Rn,Rd);
G = G_nominal_commande;
S = 1/(1+C*G);

delta1 = G_conf1-G_nominal_commande;
BF1 = -C*S*delta1
delta2 = G_conf2-G_nominal_commande;
BF2 = -C*S*delta2
delta3 = G_conf3-G_nominal_commande;
BF3 = -C*S*delta3
delta4 = G_conf4-G_nominal_commande;
BF4 = -C*S*delta4
